...
<<<<<<< HEAD
    ...
    // @LINE:15
    case controllers_Application_create3_route(params) =>
      call { 
        controllers_Application_create3_invoker.call(Application_2.create)
      }
  
    // @LINE:16
    case controllers_Application_save4_route(params) =>
      call(params.fromPath[String]("id", None)) { (id) =>
        controllers_Application_save4_invoker.call(Application_2.save(id))
      }
  
    // @LINE:19
    case controllers_Application_edit5_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_edit5_invoker.call(Application_2.edit(id))
      }
  
    // @LINE:20
    case controllers_Application_update6_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_update6_invoker.call(Application_2.update(id))
      }
  
    // @LINE:23
    case controllers_Application_delete7_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_delete7_invoker.call(Application_2.delete(id))
      }
    ...
    // @LINE:27
    case controllers_AuthController_callback9_route(params) =>
      call(params.fromQuery[Option[String]]("code", None)) { (code) =>
        controllers_AuthController_callback9_invoker.call(AuthController_0.callback(code))
      }
